                    ...
                    <form method="POST" class="form-horizontal" action="/users/{{ $user->id or '' }}">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-sm-4">
                                        <input name="name" value="{{ Input::old('name', $user->name) }}" type="text"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-sm-4">
                                        <input name="kana" value="{{ Input::old('kana', $user->kana) }}" type="text"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-sm-10">
                                        <input name="email" value="{{ Input::old('email', $user->email)  }}" type="text"
                                               class="form-control" placeholder="example@mail.com" readonly>
                                    </div>
                                </td>
                            </tr>
                            @if ($header_role > 1)
                                    ...
                                    <td>
                                        <div class="col-sm-10">
                                            <select class="form-control" name="role">
                                                <option value="2"
                                                        @if (Input::old('role', $user->role) != '1') selected="selected" @endif >
                                                    管理者
                                                </option>
                                                <option value="1"
                                                        @if (Input::old('role', $user->role) == '1') selected="selected" @endif>

        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    @endif
                    <form method="POST" class="form-horizontal" action="/groups/{{ $group->id or '' }}">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-sm-4">
                                        <input name="name" value="{{ Input::old('name', $group->name) }}" type="text"
                                               class="form-control" placeholder="第一開発課">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <th><label class="col-sm-4 control-label">管理番号</label></th>
                                <td>
                                    <div class="col-sm-10">
                                        <input name="group" value="{{ Input::old('group', $group->group)  }}"
                                               type="text" class="form-control" placeholder="10">
                                    </div>
                                </td>
                            </tr>

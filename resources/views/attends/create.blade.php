        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <form method="POST" class="form-horizontal" action="/attends/create">
                                            ...
                                            <select class="form-control" name="user_key">
                                                @foreach($users as $user)
                                                    <option value="{{ $user->key }}"
                                                            @if (Input::old('user_key', $attend->user_key) == $user->key) selected="selected" @endif>{{ $user->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </td>
                                ...
                                <td>
                                    <div class="col-sm-4">
                                        <input name="attend_at"
                                               value="{{ Input::old('attend_at', $attend->attend_at) }}" type="text"
                                ...
                                <td>
                                    <div class="col-sm-10">
                                        <select class="form-control" name="type">
                                            <option value="1"
                                                    @if (Input::old('type') == '1') selected="selected" @endif>有給（全休）
                                            </option>
                                            <option value="2"
                                                    @if (Input::old('type') == '2') selected="selected" @endif>有給（午前半休）
                                            </option>
                                            <option value="3"
                                                    @if (Input::old('type') == '3') selected="selected" @endif>有給（午後半休）
                                            </option>
                                            <option value="4"
                                                    @if (Input::old('type') == '4') selected="selected" @endif>欠勤
                                            </option>
                                            <option value="5"
                                                    @if (Input::old('type') == '5') selected="selected" @endif>遅刻
                                            </option>
                                            <option value="6"
                                                    @if (Input::old('type') == '6') selected="selected" @endif>早退
                                            </option>
                                            <option value="7"
                                                    @if (Input::old('type') == '7') selected="selected" @endif>代休（全休）
                                            </option>
                                            <option value="8"
                                                    @if (Input::old('type') == '8') selected="selected" @endif>代休（午前半休）
                                            </option>
                                            <option value="9"
                                                    @if (Input::old('type') == '9') selected="selected" @endif>代休（午後半休）
                                            </option>
                                        </select>
                                    </div>
                                </td>
